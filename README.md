...
2. Use the Alan Ionic SDK to embed the Alan button to your app. For details, see <a href="https://alan.app/docs/client-api/cross-platform/ionic" target="_blank">Alan AI documentation</a>.
